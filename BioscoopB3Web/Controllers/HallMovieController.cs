...
namespace BioscoopB3Web.Controllers
{
    public class HallMovieController : Controller
    {
        ...
        public HallMovieController(IHallMovieRepository HallMovieRepo, IMovieRepository MovieRepo, IHallLayoutRepository HallLayoutRepo, ITicketRepository TicketRepo)
        {
